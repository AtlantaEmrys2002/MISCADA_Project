...
#         #
#         #     indices = np.random.choice(train_data.shape[0], size=1000, replace=False)
#         #
...
#         # # NORMALISE
#         #
#         # mean = np.mean(train_map_patches)
#         # sigma = np.std(train_map_patches)
#         #
#         # train_map_patches = (train_map_patches - mean) / sigma
#
#
#
#
...
#     # # NORMALISE
#     #
#     # mean = np.mean(test_map_patches)
#     # sigma = np.std(test_map_patches)
#     #
#     # test_map_patches = (test_map_patches - mean) / sigma
#
#
