...
BINNEDBACKGROUND=/Volumes/T7/data/sky_map_creation_data/fermi_binned_background.fits
...
cp /Volumes/T7/data/sky_map_creation_data/fermi_filtered_gti.fits /Volumes/T7/data/empty_evfile.fits

# gtbin evfile=none scfile=NONE outfile=$FERMIBACKGROUNDCMAP algorithm=HEALPIX ebinalg=LOG emin=300 emax=200000 enumbins=6 nxpix=360 nypix=180 binsz=1 hpx_ordering_scheme=RING hpx_order=8 xref=0 axisrot=0 proj=AIT yref=0
