...
import argparse
import copy
from create_patches_2 import create_patches_for_catalog_2
import healpy as hp
...
if __name__ == "__main__":
    ...
    f1 = open(save_directory + "/patches_2/patch_metadata_2.csv", "w+")
    ...
    pool.map(create_patches_for_catalog_2, arguments)
    ...
    for c in range(num_catalogs):
        with open(save_directory + "/patches_2/catalog_{}_patch_metadata_2.csv".format(c)) as f3:
            lines = f3.readlines()

            new_lines += lines

    f1 = open(save_directory + "/patches_2/patch_metadata_2.csv", "a")
