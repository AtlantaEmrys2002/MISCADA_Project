...
#         # READ IN MAPS AND SPATIAL/SPECTRAL PARAMETERS
#
#         skymaps_directory = save_directory + "/count_maps/skymap_{}".format((catalog_id * num_maps_per_catalog) + m +
#         1)
#
#         # Read in the coordinates and associated integral photon fluxes of each source in AGN and pulsar maps
#
...
#                 for i in range(nagn):
#                     # Find the minimum of the position in the image and 127 (the maximum index of the image in the y
#                     or
#                     # x-axis)
...
# Concatenate Lists - https://stackoverflow.com/questions/1720421/how-do-i-concatenate-two-lists-in-python
# If-Else One Line - https://stackoverflow.com/questions/2802726/putting-a-simple-if-then-else-statement-on-one-line
