...
python create_mock_skymaps.py --exposure_fits=/Volumes/T7/project_data/real_data/fermi_filtered_gti_exposure_map.fits --number_catalogs=1 --pointsource_psf=/Volumes/T7/project_data/real_data/pointsource_psf.fits --diffuse_source_psf_roi=/Volumes/T7/project_data/real_data/diffuse_psf_roi/count_map.fits --isotropic_background=/Volumes/T7/data/background_models/iso_P8R3_SOURCE_V3_v1.txt --galactic_background=/Volumes/T7/data/background_models/gll_iem_v07.fits --num_maps_per_catalog=1
...
# python create_dataset.py --num_catalogs=1 --num_skymaps_per_catalog=1 --num_energy_bins=5 --patch_directory=./simulated_data
