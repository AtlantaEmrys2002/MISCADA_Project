...
python create_mock_catalogs.py --catalog=/Volumes/T7/data/catalog/4FGL_DR4.fit --number=1 --analyse=no --verify=first
...
# python3 create_dataset.py --num_catalogs=10 --num_skymaps_per_catalog=10 --num_energy_bins=5 --patch_directory=./simulated_data
