...
def create_catalog(params):
    ...
    lat_agn, lat_pulsar, threshold, agn_noise_cols, psr_noise_cols = (
    ...
    simulated_agn = generate_mock_agn_catalog(fermi_catalog, lat_agn, agn_noise_cols,
                                              detection_threshold=threshold)

    # Generate simulated pulsar sources

    simulated_pulsar = generate_mock_pulsar_catalog(fermi_catalog, lat_pulsar, psr_noise_cols,
                                                    detection_threshold=threshold)
