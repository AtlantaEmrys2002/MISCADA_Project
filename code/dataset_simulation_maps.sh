...
##gtltcube evfile=$FERMIDATACUTGTI scfile=$SPACECRAFTFILE outfile=$FERMILIVETIMECUBE zmax=100 dcostheta=0.025 binsz=0.23
#gtltcube evfile=$FERMIDATACUTGTI scfile=$SPACECRAFTFILE outfile=$FERMILIVETIMECUBE zmax=100 dcostheta=0.099 binsz=0.23
#
#
...
## gtbin evfile=$FERMIDATACUTGTI scfile=NONE outfile=$FERMIBINNED algorithm=HEALPIX coordsys=GAL ebinalg=LOG emin=300 emax=200000 enumbins=16 hpx_ordering_scheme=RING hpx_order=7 # xref=0 axisrot=0 proj=AIT yref=0
#
## LAST
#gtbin evfile=$FERMIDATACUTGTI scfile=NONE outfile=$FERMIBINNED algorithm=HEALPIX coordsys=GAL ebinalg=LOG emin=300 emax=200000 enumbins=16 hpx_ordering_scheme=RING hpx_order=8 # xref=0 axisrot=0 proj=AIT yref=0
#
#
#
...
# gtbin evfile=$FERMIDATACUTGTI scfile=NONE outfile=$FERMIBINNED algorithm=HEALPIX coordsys=GAL ebinalg=LOG emin=300 emax=200000 enumbins=16 hpx_ordering_scheme=RING hpx_order=8
# gtltcube evfile=$FERMIDATACUTGTI scfile=$SPACECRAFTFILE outfile=$FERMILIVETIMECUBE zmax=100 dcostheta=0.025 binsz=0.23
gtexpcube2 infile=$FERMILIVETIMECUBE cmap=$FERMIBINNED outfile=$FERMIEXPMAP irfs=P8R3_ULTRACLEANVETO_V3 hpx_ordering_scheme=RING hpx_order=8 # enumbins=16 binsz=0.23
gtpsf expcube=$FERMILIVETIMECUBE outfile=$POINTSOURCEPSF irfs=P8R3_ULTRACLEANVETO_V3 ra=252.131996 dec=41.585827 emin=300 emax=200000 nenergies=5 thetamax=50 ntheta=300 evtype=3
