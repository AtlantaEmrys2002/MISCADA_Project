...
gtexpcube2 cmap=$FERMIBACKGROUNDCMAP evtype=3 binsz=0.23 infile=$LTCUBE outfile=/Volumes/T7/data/sky_map_creation_data/fermi_filtered_exp_from_bin.fits irfs=P8R3_ULTRACLEANVETO_V3
